...
filename_rothe_01="../hydrogen_simulations_SIMPLIFIED_shift/outputs/NEWNEW/data_E00.060_omega0.057_invRmu100_dt0.20_epsilon2.50e-02_frozenCore.h5"
...
filename_rothe_05="../hydrogen_simulations_SIMPLIFIED_shift/outputs/NEWNEW/data_E00.060_omega0.057_invRmu100_dt0.20_epsilon2.50e-01_frozenCore.h5"
...
filename_rothe_25="../hydrogen_simulations_SIMPLIFIED_shift/outputs/NEWNEW/data_E00.060_omega0.057_invRmu100_dt0.20_epsilon1.00e+00_frozenCore.h5"
...
time_points_coccia=np.load("../tdse_pyscf/time_points_E=0.06.txt.npy")
z_t_coccia_noAbsorber=np.load("../tdse_pyscf/z_E=0.06_absorber=0.txt.npy")[time_points_coccia <= t_stop]
...
omega_s_R25, Px_R3 = compute_hhg_spectrum(time_points_rothe_25[:-1], (-dipole_moment_rothe_25)[:-1], hann_window=hann_window)
...
ax1.semilogy(omega_s_R25 / omega, omega_s_R25**2*Px_R3, color="blue",linestyle="dashed", label=r"Rothe ($M_{max}=%d$)"%N_T_f_25)
...
plt.savefig("hhg_E0=0.06.png",dpi=300)
plt.savefig("hhg_E0=0.06.svg")

plt.savefig("hhg_E0=0.06.pdf")
plt.show()
